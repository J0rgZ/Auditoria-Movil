...
public class r2 {
    ...
    public static r2 s(Context context, int i, int[] iArr) {
    ...
    public static r2 u(Context context, AttributeSet attributeSet, int[] iArr, int i, int i2) {
    ...
    public ColorStateList c(int i) {
        int resourceId;
        ColorStateList c;
        if (this.b.hasValue(i) && (resourceId = this.b.getResourceId(i, 0)) != 0 && (c = b.b.c(this.a, resourceId)) != null) {
            return c;
        }
    ...
    public Drawable g(int i) {
        ...
        if (this.b.hasValue(i) && (resourceId = this.b.getResourceId(i, 0)) != 0) {
            return b.b.d(this.a, resourceId);
        }
    ...
    public Drawable h(int i) {
        int resourceId;
        if (this.b.hasValue(i) && (resourceId = this.b.getResourceId(i, 0)) != 0) {
            return k.b().d(this.a, resourceId, true);
        }
        return null;
    }
    ...
    public Typeface j(int i, int i2, h.c cVar) {
        ...
        return k.h.f(this.a, resourceId, this.c, i2, cVar);
    }
