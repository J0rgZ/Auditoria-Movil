...
public abstract class m2 extends CompoundButton {
    ...
    public static class a extends Property {
        ...
        @Override // android.util.Property
        /* renamed from: b */
        public void set(m2 m2Var, Float f) {
            m2Var.setThumbPosition(f.floatValue());
        }
    }
    ...
    public m2(Context context, AttributeSet attributeSet, int i) {
        ...
        r2 u = r2.u(context, attributeSet, R$styleable.K, i, 0);
        Drawable g = u.g(R$styleable.SwitchCompat_android_thumb);
        this.mThumbDrawable = g;
        if (g != null) {
            g.setCallback(this);
        }
        Drawable g2 = u.g(R$styleable.SwitchCompat_track);
        this.mTrackDrawable = g2;
        if (g2 != null) {
            g2.setCallback(this);
        }
        this.mTextOn = u.p(R$styleable.SwitchCompat_android_textOn);
        this.mTextOff = u.p(R$styleable.SwitchCompat_android_textOff);
        this.mShowText = u.a(R$styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = u.f(R$styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = u.f(R$styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = u.f(R$styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = u.a(R$styleable.SwitchCompat_splitTrack, false);
        ColorStateList c = u.c(R$styleable.SwitchCompat_thumbTint);
        if (c != null) {
            this.mThumbTintList = c;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode e = o1.e(u.k(R$styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        ColorStateList c2 = u.c(R$styleable.SwitchCompat_trackTint);
        if (c2 != null) {
            this.mTrackTintList = c2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode e2 = o1.e(u.k(R$styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        int n = u.n(R$styleable.SwitchCompat_switchTextAppearance, 0);
        if (n != 0) {
    ...
    public final void b() {
        ...
        if (drawable != null) {
            if (this.mHasThumbTint || this.mHasThumbTintMode) {
                Drawable mutate = m.h.r(drawable).mutate();
                this.mThumbDrawable = mutate;
                if (this.mHasThumbTint) {
                    m.h.o(mutate, this.mThumbTintList);
                }
                if (this.mHasThumbTintMode) {
                    m.h.p(this.mThumbDrawable, this.mThumbTintMode);
                }
        ...
        if (drawable != null) {
            if (this.mHasTrackTint || this.mHasTrackTintMode) {
                ...
                if (this.mHasTrackTint) {
                    m.h.o(mutate, this.mTrackTintList);
                }
                if (this.mHasTrackTintMode) {
                    m.h.p(this.mTrackDrawable, this.mTrackTintMode);
                }
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable3 != null) {
            ...
            if (background != null) {
                m.h.l(background, i15, i4, i16, i6);
            }
        }
        super.draw(canvas);
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            Rect d = o1.d(this.mThumbDrawable);
    ...
    */
    ...
    public void setChecked(boolean z) {
        ...
        super.setChecked(z);
        boolean isChecked = isChecked();
        if (getWindowToken() != null && v.d1.Q(this)) {
            a(isChecked);
            return;
        }
        d();
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        int f = s2.f(R$styleable.TextAppearance_android_textSize, 0);
        if (f != 0) {
            float f2 = f;
        ...
        i(s2.k(R$styleable.TextAppearance_android_typeface, -1), s2.k(R$styleable.TextAppearance_android_textStyle, -1));
        if (s2.a(R$styleable.TextAppearance_textAllCaps, false)) {
            this.mSwitchTransformationMethod = new d.a(getContext());
        } else {
    ...
    public void setThumbResource(int i) {
        setThumbDrawable(b.b.d(getContext(), i));
    }
    ...
    public void setTrackResource(int i) {
        setTrackDrawable(b.b.d(getContext(), i));
    }
