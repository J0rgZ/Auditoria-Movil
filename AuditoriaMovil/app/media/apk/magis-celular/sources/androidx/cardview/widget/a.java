...
public abstract class a extends FrameLayout {
    ...
    public class C0011a implements e {
        ...
        public void a(int i, int i2) {
            a aVar = a.this;
            if (i > aVar.mUserSetMinWidth) {
                a.super.setMinimumWidth(i);
            }
            a aVar2 = a.this;
            if (i2 > aVar2.mUserSetMinHeight) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!(fVar instanceof c)) {
            ...
            if (mode == Integer.MIN_VALUE || mode == 1073741824) {
                i = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil(fVar.l(this.mCardViewDelegate)), View.MeasureSpec.getSize(i)), mode);
            }
            int mode2 = View.MeasureSpec.getMode(i2);
            if (mode2 == Integer.MIN_VALUE || mode2 == 1073741824) {
                i2 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil(fVar.k(this.mCardViewDelegate)), View.MeasureSpec.getSize(i2)), mode2);
            }
    ...
    public a(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mCardViewDelegate = c0011a;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.a, i, R$style.CardView);
        ...
        IMPL.a(c0011a, context, colorStateList, dimension, dimension2, f);
    }
