...
public class d {
    ...
    public final c.AbstractC0035c e;
    ...
    public class a extends a.AbstractBinderC0032a {
        ...
        public void a(String[] strArr) {
            d.this.g.execute(new RunnableC0036a(strArr));
        }
    }
    ...
    public class f extends c.AbstractC0035c {
        ...
        public void b(Set set) {
            ...
            try {
                ...
                androidx.room.b bVar = dVar.f;
                if (bVar != null) {
                    bVar.c(dVar.c, (String[]) set.toArray(new String[0]));
                }
            } catch (RemoteException unused) {
            }
        }
